...
//September 26, 2023
//ArrayBag.hpp defines the constructors and private and public function implementation of the ArrayBag class
...
class ArrayBag
{
   public:
        ...
        **/
        ...
        void operator/=(const ArrayBag<ItemType>& noDupes);
        void operator+=(const ArrayBag<ItemType>& yesDupes);
