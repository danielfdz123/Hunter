...
bool timeOverlap(TimeSlot ts1, TimeSlot ts2)
{
    ...
    int movie1end = movie1start + ts1.movie.duration;
    int movie2end = movie2start + ts2.movie.duration;
...
int main()
{
    ...
    if (timeOverlap(daytime, daytime2))
    {
        cout << "The movie times overlap." << endl;
    }
    else
    {
        cout << "The movie times do not overlap." << endl;
    }
}
